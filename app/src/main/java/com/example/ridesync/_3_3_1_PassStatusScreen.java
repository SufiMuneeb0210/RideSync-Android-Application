...
public class _3_3_1_PassStatusScreen extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void Search(String _parameter, String _secondmessage)
    {
        ...
        ActivityRef.child("Pass").child(sessionManager.getEmail()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(Counter>0)
                {
                    Toast.makeText(_3_3_1_PassStatusScreen.this, "Total "+Counter+" Passes found", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(_3_3_1_PassStatusScreen.this, "Nothing found!", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(_3_3_1_PassStatusScreen.this, "Error: "+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
